        ...
        <div className="navbox">
          <div className="list_holder">
            <ul className="metaportal_fn_items">
              ...
              <li>
                <div className="item">
                  <a
                    href="https://discord.gg/FQNvz9T2"
                    target="_blank"
                    rel="noreferrer"
                  />
                  <span className="icon">
            ...
            >
              ...
              <li>
                <Link href="/collection">
                  <a onClick={() => navigationToggle(false)}>
                    <span className="creative_link">Portfolio</span>
                  </a>
                </Link>
              </li>
              <li>
          ...
          <div className="info_holder">
            ...
            <div className="social_icons">
              <ul>
                <li>
                  <a href="https://twitter.com/MudassirrMirza">
                    <img
                ...
                <li>
                  <a href="https://www.linkedin.com/in/mudassirmirza/">
                    <img
